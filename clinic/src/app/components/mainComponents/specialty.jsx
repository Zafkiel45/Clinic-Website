    ...
    return (
        <section className="w-screen h-fit bg-slate-50 py-10">
            ...
            <div className="flex flex-col gap-5 text-sm items-center flex-wrap">
                <div className="bg-white shadow-md w-[80%] p-5 rounded-lg h-72 text-gray-400">
                    <div className="w-full pb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24" className="fill-red-500 mx-auto" viewBox="0 -960 960 960" width="24"><path d="M410-120v-238L204-239l-70-121 206-120-206-119 70-121 206 119v-239h140v239l206-119 70 121-206 119 206 120-70 121-206-119v238H410Z"/></svg>
                    </div>
                    <div className="p-3">
