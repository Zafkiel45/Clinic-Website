    ...
    return (
        <section id="specialty" className="w-screen h-fit bg-slate-50 py-10">
            ...
            <div className="flex tabletMini:flex-row tabletMini:justify-center flex-col gap-5 desktopMini:text-base text-center text-sm items-center flex-wrap">
                <div data-aos="fade-left" data-aos-delay="50" className="bg-white shadow-md tabletMini:w-[33.3%] mobileMini:w-[60%] w-[70%] p-5 rounded-lg tabletMini:h-72 h-72 text-gray-400">
                ...
                <div data-aos="fade-right" data-aos-delay="50" className="bg-white shadow-md tabletMini:w-[33.3%] mobileMini:w-[60%] w-[70%] p-5 rounded-lg tabletMini:h-72 h-72 text-gray-400">
                    <div className="w-full pb-3">
                ...
                <div data-aos="fade-left" data-aos-delay="100"  className="bg-white shadow-md tabletMini:w-[33.3%] mobileMini:w-[60%] w-[70%] p-5 rounded-lg tabletMini:h-72 h-72 text-gray-400">
                    <div className="w-full pb-3">
                ...
                <div data-aos="fade-right" data-aos-delay="100"  className="bg-white shadow-md tabletMini:w-[33.3%] mobileMini:w-[60%] w-[70%] p-5 rounded-lg tabletMini:h-72 h-72 text-gray-400">
                    <div className="w-full pb-3">
                ...
                <div data-aos="fade-left" data-aos-delay="150"  className="bg-white shadow-md tabletMini:w-[33.3%] mobileMini:w-[60%] w-[70%] p-5 rounded-lg tabletMini:h-72 h-72 text-gray-400">
                    <div className="w-full pb-3">
                ...
                <div data-aos="fade-right" data-aos-delay="150"  className="bg-white shadow-md tabletMini:w-[33.3%] mobileMini:w-[60%] w-[70%] p-5 rounded-lg tabletMini:h-72 h-72 text-gray-400">
                    <div className="w-full pb-3">
