    ...
    return (
        <section className="w-screen h-fit bg-slate-50 py-10">
            ...
            <div className="w-screen h-fit p-3 mt-4 flex justify-center items-center">
                <Link href={'#'}>
                    <button className="bg-blue-400 w-fit h-fit py-1 px-5 text-white font-bold shadow-sm rounded-lg">
                        Ver mais
                    </button>
                </Link>
            </div>
