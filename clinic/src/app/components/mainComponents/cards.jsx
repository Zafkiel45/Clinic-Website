export const Cards = () => {
    return (
        <section className="relative w-full h-auto p-3 flex justify-center">
            <div className="absolute flex flex-col gap-3 top-[-50px]">
                <div className="bg-white border p-2 border-gray-200 w-64 rounded-lg shadow-lg flex flex-col justify-center gap-2">
                    <div className="m-auto"> 
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="fill-gray-500" class="bi bi-calendar-check" viewBox="0 0 16 16">
