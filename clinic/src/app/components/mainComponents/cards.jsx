export const Cards = () => {
    return (
        <section className="w-full h-fit py-10 flex justify-center bg-slate-50">
            <div data-aos="fade-up" className=" h-fit flex flex-col min-[890px]:justify-center tabletMini:flex-row gap-3">
